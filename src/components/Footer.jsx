  ...
  return (
    <footer className="bg-black text-white pb-10 mt-auto">
      ...
      <div className="max-w-7xl mx-auto px-4 grid md:grid-cols-3 gap-8 text-sm pt-6">
        <div>
          <div className="mb-2 font-semibold">
            Specializes in providing high-class tours for those in need.<br/>ContactUs
          </div>
          <a href="mailto:info@terranest.ae" className="mb-1 flex items-center gap-2">
      ...
      <div className="text-center mt-8 text-xs text-gray-400">
        ©2025 Prime Haven Properties LLC.
      </div>
    </footer>
  );
};
