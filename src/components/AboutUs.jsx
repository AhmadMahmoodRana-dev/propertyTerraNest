    ...
    >
      ...
      <div className="py-5 w-full h-full relative z-20 flex justify-center md:items-start items-center flex-col px-5 md:px-20">
        ...
        <p className="w-full md:w-[640px] tracking-wider text-white text-lg sm:text-xl italic text-center md:text-left">
          ...
          Why Terra Nest Properties? <br /> At Terra Nest Properties, we combine
          deep market expertise with a passion for delivering personalized
          service. Whether you’re buying, selling, renting, or investing, our
          dedicated team is here to provide a smooth, hassle-free experience,
          supporting you every step of the way on your real estate journey.
        </p>
